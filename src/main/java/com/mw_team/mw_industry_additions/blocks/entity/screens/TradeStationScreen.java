...
public class TradeStationScreen extends AbstractContainerScreen<TradeStationMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(IndustrialAdditions.MOD_ID, "textures/gui/trade_station.png");

    public TradeStationScreen(TradeStationMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
